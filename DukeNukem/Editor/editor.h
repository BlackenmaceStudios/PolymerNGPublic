...
#define VERSION __DATE__ " " __TIME__ " PolymerNG"

extern const char *defaultsetupfilename;
extern "C" char setupfilename[BMAX_PATH];
...
extern "C" int16_t editstatus, searchit;
extern "C" int32_t searchx, searchy;
extern int32_t osearchx, osearchy;      //search input

extern "C" int16_t searchsector, searchwall, searchstat;  //search output
extern "C" int16_t searchbottomwall, searchisbottom;
...
extern "C" int32_t scalescreeny(int32_t sy);
extern "C" void screencoords(int32_t *xres, int32_t *yres, int32_t x, int32_t y, int32_t zoome) ATTRIBUTE((nonnull));
//extern void invscreencoords(int32_t *dx, int32_t *dy, int32_t sx, int32_t sy, int32_t zoome);
extern "C" int32_t getinvdisplacement(int32_t *dx, int32_t *dy, int32_t dz) ATTRIBUTE((nonnull));
extern "C" int32_t getscreenvdisp(int32_t bz, int32_t zoome);
extern "C" void setup_sideview_sincos(void);
...
extern void showsectordata(int16_t _sectnum, int16_t _small);
extern void showwalldata(int16_t _wallnum, int16_t _small);
extern void showspritedata(int16_t _spritenum, int16_t _small);
...
extern "C" int32_t loadsetup(const char *fn);	// from config.c
extern "C" int32_t writesetup(const char *fn);	// from config.c
