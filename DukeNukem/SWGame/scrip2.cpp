                            ...
                            case CM_FILENAME:
                                {
                                    ...
                                    custommaps[curmap].LevelName = _strdup ( t );
                            ...
                            case CM_SONG:
                                {
                                    ...
                                    custommaps[curmap].SongName = _strdup ( t );
                            ...
                            case CM_TITLE:
                                {
                                    ...
                                    custommaps[curmap].Description = _strdup ( t );
                            ...
                            case CM_BESTTIME:
                                {
                                    ...
                                    custommaps[curmap].BestTime = _strdup ( s );
                            ...
                            case CM_PARTIME:
                                {
                                    ...
                                    custommaps[curmap].ParTime = _strdup ( s );
            ...
            case CM_INVENTORY:
                {
                    ...
                    if ( name )
                    {
                        ...
                        custominventoryname[in] = _strdup ( name );
            ...
            case CM_WEAPON:
                {
                    ...
                    if ( weaponmap[in].editable & WM_WEAP )
                    {
                        ...
                        if ( name )
                        {
                            ...
                            customweaponname[0][id] = _strdup ( name );
                    ...
                    if ( weaponmap[in].editable & WM_AMMO )
                    {
                        if ( ammo )
                        {
                            ...
                            customweaponname[1][id] = _strdup ( ammo );
