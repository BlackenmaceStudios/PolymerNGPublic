...
void ReadGameSetup ( int32 scripthandle )
{
    ...
    SCRIPT_GetString ( scripthandle, "Options", "Rooster", ( char * ) gs.Password );
    DecodePassword ( ( char * ) gs.Password );
    // option stuff
    dummy = -1;
...
void WriteGameSetup ( int32 scripthandle )
{
    ...
    EncodePassword ( ( char * ) gs.Password );
    SCRIPT_PutString ( scripthandle, "Options", "Rooster", ( char * ) gs.Password );
    DecodePassword ( ( char * ) gs.Password );
