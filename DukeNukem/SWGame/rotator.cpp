...
void DoRotatorSetInterp ( short SpriteNum )
{
    ...
    {
        setinterpolation ( ( int32_t * ) &wall[w].x );
        setinterpolation ( ( int32_t * ) &wall[w].y );
        setinterpolation ( ( int32_t * ) &wall[DRAG_WALL ( w )].x );
        setinterpolation ( ( int32_t * ) &wall[DRAG_WALL ( w )].y );
    }
}
...
void DoRotatorStopInterp ( short SpriteNum )
{
    ...
    for ( w = startwall; w <= endwall; w++ )
    {
        stopinterpolation ( ( int32_t * ) &wall[w].x );
        stopinterpolation ( ( int32_t * ) &wall[w].y );
        stopinterpolation ( ( int32_t * ) &wall[DRAG_WALL ( w )].x );
        stopinterpolation ( ( int32_t * ) &wall[DRAG_WALL ( w )].y );
    }
}
