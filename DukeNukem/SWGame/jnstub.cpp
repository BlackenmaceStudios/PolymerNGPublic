...
extern BOOL bSpinBobVoxels;             // Do twizzly stuff to voxels
extern BOOL bAutoSize;                  // Autosizing on/off
...
// jmarshall start
void DoAutoSize(spritetype * tspr);
/*
void
...
void ExtAnalyzeSprites (int32_t ourx, int32_t oury, int32_t oura, int32_t smoothr)
{
    ...
    for ( i = 0, tspr = (spritetype *)&tsprite[0]; i < spritesortcnt; i++, tspr++ )
    {
...
static char *startwin_labeltext = "Starting Build Editor for Shadow Warrior...";
...
#define DEFAULT_SKILL 2
    ...
    // only newp walls get their extra's set
...
{
    typedef short GET_NUM_FUNC ( char *, int32_t, int32_t, char, const char *(func)(int32_t));
    ...
    if ( qsetmode == MODE_3D )
    {
        getnumber = (GET_NUM_FUNCp)_getnumber256;
        printmessage = ( PRINT_MSG_FUNCp ) printmessage256;
    }
    
    else
    {
        getnumber = (GET_NUM_FUNCp)_getnumber16;
        printmessage = (PRINT_MSG_FUNCp)_printmessage16;
    ...
    if ( KEY_PRESSED ( KEYSC_RALT + 128 ) && KEY_PRESSED ( KEYSC_RCTRL + 128 ) )
    {
        if ( KEY_PRESSED ( KEYSC_KPMINUS ) )
        {
            ...
            gvisibility = gvisibility - ( ((int32_t)gvisibility) >> 3 );
                ...
                switch ( searchstat )
                {
                    case 3:
                        ...
                        SPRITE_TAG11 ( searchwall ) =
                            getnumber ( tempbuf, SPRITE_TAG11 ( searchwall ), 65536L, 0, NULL );
                        break;
                }
                ...
                switch ( searchstat )
                {
                    case 3:
                        ...
                        SPRITE_TAG12 ( searchwall ) =
                            getnumber ( tempbuf, SPRITE_TAG12 ( searchwall ), 65536L, 0, NULL);
                        break;
                }
                ...
                switch ( searchstat )
                {
                    case 3:
                        ...
                        SPRITE_TAG13 ( searchwall ) =
                            getnumber ( tempbuf, SPRITE_TAG13 ( searchwall ), 65536L, 0, NULL);
                        break;
                }
                ...
                switch ( searchstat )
                {
                    case 3:
                        ...
                        SPRITE_TAG14 ( searchwall ) =
                            getnumber ( tempbuf, SPRITE_TAG14 ( searchwall ), 65536L, 0, NULL);
                        break;
                }
                ...
                switch ( searchstat )
                {
                    case 3:
                        ...
                        SPRITE_TAG15 ( searchwall ) =
                            getnumber ( tempbuf, SPRITE_TAG15 ( searchwall ), 65536L, 0, NULL);
                        break;
                }
        ...
        if ( keystatus[KEYSC_1] )
        {
            ...
            switch ( searchstat )
            {
                ...
                case 4:
                    ...
                    wall[searchwall].hitag =
                        getnumber ( tempbuf, wall[searchwall].hitag, 65536L, 0, NULL);
                    break;
                ...
                case 2:
                    ...
                    sector[searchsector].hitag =
                        getnumber ( tempbuf, sector[searchsector].hitag, 65536L, 0, NULL);
                    break;
                    
                case 3:
                    strcpy ( tempbuf, "Sprite tag 1 (hitag): " );
                    SPRITE_TAG1 ( searchwall ) =
                        getnumber ( tempbuf, SPRITE_TAG1 ( searchwall ), 65536L, 0, NULL);
                    break;
            }
        ...
        if ( keystatus[KEYSC_2] )
        {
            ...
            switch ( searchstat )
            {
                ...
                case 4:
                    ...
                    wall[searchwall].lotag =
                        getnumber ( tempbuf, wall[searchwall].lotag, 65536L, 0, NULL);
                    break;
                ...
                case 2:
                    ...
                    sector[searchsector].lotag =
                        getnumber ( tempbuf, sector[searchsector].lotag, 65536L, 0, NULL);
                    break;
                    
                case 3:
                    strcpy ( tempbuf, "Sprite tag 2 (lotag): " );
                    SPRITE_TAG2 ( searchwall ) =
                        getnumber ( tempbuf, SPRITE_TAG2 ( searchwall ), 65536L, 0, NULL);
            ...
            switch ( searchstat )
            {
                ...
                case 4:
                    ...
                    wall[searchwall].xpanning =
                        getnumber ( tempbuf, wall[searchwall].xpanning, 65536L, 0, NULL);
                    break;
                ...
                case 2:
                    ...
                    sector[searchsector].ceilingxpanning =
                        getnumber ( tempbuf, sector[searchsector].ceilingxpanning, 65536L, 0, NULL);
                    break;
                    
                case 3:
                    strcpy ( tempbuf, "Sprite tag 3 (clipdist) : " );
                    SPRITE_TAG3 ( searchwall ) =
                        getnumber ( tempbuf, SPRITE_TAG3 ( searchwall ), 65536L, 0, NULL);
                    break;
            }
            ...
            switch ( searchstat )
            {
                ...
                case 4:
                    ...
                    wall[searchwall].ypanning =
                        getnumber ( tempbuf, wall[searchwall].ypanning, 65536L, 0, NULL);
                    break;
                ...
                case 2:
                    ...
                    sector[searchsector].ceilingypanning =
                        getnumber ( tempbuf, sector[searchsector].ceilingypanning, 65536L, 0, NULL);
                    break;
                    
                case 3:
                    strcpy ( tempbuf, "Sprite tag 4 (ang) : " );
                    SPRITE_TAG4 ( searchwall ) =
                        getnumber ( tempbuf, SPRITE_TAG4 ( searchwall ), 65536L, 0, NULL);
                    break;
            }
            ...
            switch ( searchstat )
            {
                ...
                case 2:
                    ...
                    sector[searchsector].floorxpanning =
                        getnumber ( tempbuf, sector[searchsector].floorxpanning, 65536L, 0, NULL);
                    break;
                    
                case 3:
                    strcpy ( tempbuf, "Sprite tag 5 (xvel) : " );
                    SPRITE_TAG5 ( searchwall ) =
                        getnumber ( tempbuf, SPRITE_TAG5 ( searchwall ), 65536L, 0, NULL);
                    break;
            }
            ...
            switch ( searchstat )
            {
                ...
                case 2:
                    ...
                    sector[searchsector].floorypanning =
                        getnumber ( tempbuf, sector[searchsector].floorypanning, 65536L, 0, NULL);
                    break;
                    
                case 3:
                    strcpy ( tempbuf, "Sprite tag 6 (yvel) : " );
                    SPRITE_TAG6 ( searchwall ) =
                        getnumber ( tempbuf, SPRITE_TAG6 ( searchwall ), 65536L, 0, NULL);
                    break;
            }
            ...
            switch ( searchstat )
            {
                ...
                case 3:
                    ...
                    SPRITE_TAG7 ( searchwall ) =
                        getnumber ( tempbuf, SPRITE_TAG7 ( searchwall ), 65536L, 0, NULL);
                    break;
            }
            ...
            switch ( searchstat )
            {
                ...
                case 3:
                    ...
                    SPRITE_TAG8 ( searchwall ) =
                        getnumber ( tempbuf, SPRITE_TAG8 ( searchwall ), 65536L, 0, NULL);
                    break;
            }
            ...
            switch ( searchstat )
            {
                ...
                case 3:
                    ...
                    SPRITE_TAG9 ( searchwall ) =
                        getnumber ( tempbuf, SPRITE_TAG9 ( searchwall ), 65536L, 0, NULL);
                    break;
            }
            ...
            switch ( searchstat )
            {
                ...
                case 3:
                    ...
                    SPRITE_TAG10 ( searchwall ) =
                        getnumber ( tempbuf, SPRITE_TAG10 ( searchwall ), 65536L, 0, NULL);
                    break;
            }
        ...
        if ( keystatus[KEYSC_1] )
        {
            ...
            switch ( searchstat )
            {
                case 3:
                    ...
                    value = getnumber ( tempbuf, value, 65536L, 0, NULL);
...
ExtCheckKeys ( void )
{
    ...
    SetSpriteExtra();
    sector[0].extra = gvisibility;
    
    //  if(!BKeyPressed())
    //      ticdiff = totalclock-oldtotalclock;  // Difference in tics from last time
    
    //  oldtotalclock = totalclock; // Set old clock to newp time
...
FindNextTag ( void )
{
    ...
    siNextTag = siNextEndTag = 0;       // Reset tags for newp search
    siNextFind = 0;
