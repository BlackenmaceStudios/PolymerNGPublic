...
SpawnMidSplash ( short SpriteNum )
{
    ...
    USERp nu;
    short newp;
    newp = SpawnSprite ( STAT_MISSILE, GOREDrip, s_GoreSplash, sp->sectnum,
...
SpawnFloorSplash ( short SpriteNum )
{
    ...
    USERp nu;
    short newp;
    newp = SpawnSprite ( STAT_MISSILE, GOREDrip, s_GoreFloorSplash, sp->sectnum,
...
DoBloodSpray ( SHORT Weapon )
{
    ...
    if ( sp->xvel <= 2 )
    {
        ...
        sp->z += ( u->zchange >> 1 );
        getzsofslope ( sp->sectnum, sp->x, sp->y, ( int32_t * ) &cz, ( int32_t * ) &fz );
            ...
            case HIT_WALL:
                {
                    ...
                    else
                    {
                        ...
                        if ( sprite[wb].yvel >= 0 )
                        {
                            ...
                            {
                                getzsofslope ( wall[wallnum].nextsector, sp->x, sp->y, ( int32_t * ) &u->sy, ( int32_t * ) &u->sz );
                            }
    ...
    if ( !TEST ( u->Flags, SPR_BOUNCE | SPR_UNDERWATER ) )
    {
        ...
        USERp nu;
        short newp;
        newp = SpawnSprite ( STAT_MISSILE, GOREDrip, s_BloodSpray, sp->sectnum,
...
DoPhosphorus ( SHORT Weapon )
{
    ...
    if ( !TEST ( u->Flags, SPR_BOUNCE | SPR_UNDERWATER ) && !TEST ( sp->cstat, CSTAT_SPRITE_INVISIBLE ) )
    {
        ...
        USERp nu;
        short newp;
        newp = SpawnSprite ( STAT_SKIP4, PUFF, s_PhosphorExp, sp->sectnum,
                             sp->x, sp->y, sp->z, sp->ang, 100 );
        np = &sprite[newp];
        nu = User[newp];
            ...
            case HIT_SPRITE:
                {
                    ...
                    else
                    {
                        ...
                        {
                            PlaySound ( DIGI_GASPOP, &sp->x, &sp->y, &sp->z, ( Voc3D_Flags ) ( v3df_dontpan | v3df_doppler ) );
                            PlaySound ( DIGI_CHEMGAS, &sp->x, &sp->y, &sp->z, ( Voc3D_Flags ) ( v3df_dontpan | v3df_doppler ) );
...
SpawnRadiationCloud ( short SpriteNum )
{
    ...
    newp = SpawnSprite ( STAT_MISSILE, RADIATION_CLOUD, s_RadiationCloud, sp->sectnum,
...
PlayerInitChemBomb ( PLAYERp pp )
{
    ...
    short oclipdist;
    long dist;
    PlaySound ( DIGI_THROW, &pp->posx, &pp->posy, &pp->posz, ( Voc3D_Flags ) ( v3df_dontpan | v3df_doppler ) );
    nx = pp->posx;
    ny = pp->posy;
...
InitSpriteChemBomb ( SHORT SpriteNum )
{
    ...
    short oclipdist;
    long dist;
    PlaySound ( DIGI_THROW, &sp->x, &sp->y, &sp->z, ( Voc3D_Flags ) ( v3df_dontpan | v3df_doppler ) );
    nx = sp->x;
    ny = sp->y;
    nz = sp->z;
    // Spawn a shot
...
PlayerInitFlashBomb ( PLAYERp pp )
{
    ...
    PlaySound ( DIGI_GASPOP, &pp->posx, &pp->posy, &pp->posz, ( Voc3D_Flags ) ( v3df_dontpan | v3df_doppler ) );
...
SpawnFlashBombOnActor ( SHORT enemy )
{
    ...
    newp = SpawnSprite ( STAT_MISSILE, FIREBALL_FLAMES, s_FireballFlames, ep->sectnum,
