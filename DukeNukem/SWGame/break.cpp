...
int AutoBreakSprite ( short BreakSprite, short type )
{
    ...
    int SpawnBreakFlames ( SHORT SpriteNum, SHORT enemy );
    ...
    if ( TEST ( break_info->flags, BF_KILL ) || break_info->breaknum == -1 )
    {
        ...
        {
            SpawnBreakFlames ( BreakSprite, headspritestat[STAT_ENEMY] );    // jmarshall: added headspritestat[STAT_ENEMY] unsure if this is correct
        }
