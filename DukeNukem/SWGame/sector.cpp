...
#define SINE_SLOPED BIT(3)
                    ...
                    if ( wave_diff )
                    {
                        for ( cnt = sector_cnt - 1; cnt >= 0; cnt-- )
                        {
                            ...
                            // reset origz's based on newp range
    ...
    for ( sb = 0; sb < SIZ ( SpringBoard ); sb++ )
    {
        ...
        if ( sbp->Sector != -1 )
        {
            if ( ( sbp->TimeOut -= synctics ) <= 0 )
            {
                ...
                AnimSet ( ( long * ) &sector[sbp->Sector].floorz, destz, 256 );
        ...
        if ( SP_TAG2 ( sp ) == match && !TEST_BOOL6 ( sp ) )
        {
            ...
            if ( TEST_BOOL7 ( sp ) )
            {
                ...
                if ( pp )
                {
                    ...
                    {
                        PlayerSound ( snd2play, &pp->posx, &pp->posy, &pp->posz, ( Voc3D_Flags ) ( v3df_dontpan | v3df_follow ), pp );
                    }
                }
            }
            ...
            {
                PlaySound ( snd2play, &sp->x, &sp->y, &sp->z, ( Voc3D_Flags ) flags );
        ...
        case PRUNEGIRL_R0:
            ...
            //if(u->FlagOwner == 0)
            {
                ...
                if ( sp->lotag == CARGIRL_R0 )
                {
                    if ( choose_snd > 700 )
                    {
                        PlayerSound ( DIGI_JG44052, &pp->posx, &pp->posy, &pp->posz, ( Voc3D_Flags ) ( v3df_dontpan | v3df_follow ), pp );
                    }
                    
                    else if ( choose_snd > 500 )
                    {
                        PlayerSound ( DIGI_JG45014, &pp->posx, &pp->posy, &pp->posz, ( Voc3D_Flags ) ( v3df_dontpan | v3df_follow ), pp );
                    }
                    
                    else if ( choose_snd > 250 )
                    {
                        PlayerSound ( DIGI_JG44068, &pp->posx, &pp->posy, &pp->posz, ( Voc3D_Flags ) ( v3df_dontpan | v3df_follow ), pp );
                    }
                    
                    else
                    {
                        PlayerSound ( DIGI_JG45010, &pp->posx, &pp->posy, &pp->posz, ( Voc3D_Flags ) ( v3df_dontpan | v3df_follow ), pp );
                    }
                }
                ...
                else if ( sp->lotag == MECHANICGIRL_R0 )
                {
                    if ( choose_snd > 700 )
                    {
                        PlayerSound ( DIGI_JG44027, &pp->posx, &pp->posy, &pp->posz, ( Voc3D_Flags ) ( v3df_dontpan | v3df_follow ), pp );
                    }
                    
                    else if ( choose_snd > 500 )
                    {
                        PlayerSound ( DIGI_JG44038, &pp->posx, &pp->posy, &pp->posz, ( Voc3D_Flags ) ( v3df_dontpan | v3df_follow ), pp );
                    }
                    
                    else if ( choose_snd > 250 )
                    {
                        PlayerSound ( DIGI_JG44039, &pp->posx, &pp->posy, &pp->posz, ( Voc3D_Flags ) ( v3df_dontpan | v3df_follow ), pp );
                    }
                    
                    else
                    {
                        PlayerSound ( DIGI_JG44048, &pp->posx, &pp->posy, &pp->posz, ( Voc3D_Flags ) ( v3df_dontpan | v3df_follow ), pp );
                    }
                }
                ...
                else if ( sp->lotag == SAILORGIRL_R0 )
                {
                    if ( choose_snd > 700 )
                    {
                        PlayerSound ( DIGI_JG45018, &pp->posx, &pp->posy, &pp->posz, ( Voc3D_Flags ) ( v3df_dontpan | v3df_follow ), pp );
                    }
                    
                    else if ( choose_snd > 500 )
                    {
                        PlayerSound ( DIGI_JG45030, &pp->posx, &pp->posy, &pp->posz, ( Voc3D_Flags ) ( v3df_dontpan | v3df_follow ), pp );
                    }
                    
                    else if ( choose_snd > 250 )
                    {
                        PlayerSound ( DIGI_JG45033, &pp->posx, &pp->posy, &pp->posz, ( Voc3D_Flags ) ( v3df_dontpan | v3df_follow ), pp );
                    }
                    
                    else
                    {
                        PlayerSound ( DIGI_JG45043, &pp->posx, &pp->posy, &pp->posz, ( Voc3D_Flags ) ( v3df_dontpan | v3df_follow ), pp );
                    }
                }
                ...
                else if ( sp->lotag == PRUNEGIRL_R0 )
                {
                    if ( choose_snd > 700 )
                    {
                        PlayerSound ( DIGI_JG45053, &pp->posx, &pp->posy, &pp->posz, ( Voc3D_Flags ) ( v3df_dontpan | v3df_follow ), pp );
                    }
                    
                    else if ( choose_snd > 500 )
                    {
                        PlayerSound ( DIGI_JG45067, &pp->posx, &pp->posy, &pp->posz, ( Voc3D_Flags ) ( v3df_dontpan | v3df_follow ), pp );
                    }
                    
                    else if ( choose_snd > 250 )
                    {
                        PlayerSound ( DIGI_JG46005, &pp->posx, &pp->posy, &pp->posz, ( Voc3D_Flags ) ( v3df_dontpan | v3df_follow ), pp );
                    }
                    
                    else
                    {
                        PlayerSound ( DIGI_JG46010, &pp->posx, &pp->posy, &pp->posz, ( Voc3D_Flags ) ( v3df_dontpan | v3df_follow ), pp );
                    }
                }
                ...
                else if ( sp->lotag == TOILETGIRL_R0 )
                {
                    if ( choose_snd > 700 )
                    {
                        PlayerSound ( DIGI_WHATYOUEATBABY, &pp->posx, &pp->posy, &pp->posz, ( Voc3D_Flags ) ( v3df_dontpan | v3df_follow ), pp );
                    }
                    
                    else if ( choose_snd > 500 )
                    {
                        PlayerSound ( DIGI_WHATDIEDUPTHERE, &pp->posx, &pp->posy, &pp->posz, ( Voc3D_Flags ) ( v3df_dontpan | v3df_follow ), pp );
                    }
                    
                    else if ( choose_snd > 250 )
                    {
                        PlayerSound ( DIGI_YOUGOPOOPOO, &pp->posx, &pp->posy, &pp->posz, ( Voc3D_Flags ) ( v3df_dontpan | v3df_follow ), pp );
                    }
                    
                    else
                    {
                        PlayerSound ( DIGI_PULLMYFINGER, &pp->posx, &pp->posy, &pp->posz, ( Voc3D_Flags ) ( v3df_dontpan | v3df_follow ), pp );
                    }
                }
                ...
                else
                {
                    if ( choose_snd > 700 )
                    {
                        PlayerSound ( DIGI_SOAPYOUGOOD, &pp->posx, &pp->posy, &pp->posz, ( Voc3D_Flags ) ( v3df_dontpan | v3df_follow ), pp );
                    }
                    
                    else if ( choose_snd > 500 )
                    {
                        PlayerSound ( DIGI_WASHWANG, &pp->posx, &pp->posy, &pp->posz, ( Voc3D_Flags ) ( v3df_dontpan | v3df_follow ), pp );
                    }
                    
                    else if ( choose_snd > 250 )
                    {
                        PlayerSound ( DIGI_DROPSOAP, &pp->posx, &pp->posy, &pp->posz, ( Voc3D_Flags ) ( v3df_dontpan | v3df_follow ), pp );
                    }
                    
                    else
                    {
                        PlayerSound ( DIGI_REALTITS, &pp->posx, &pp->posy, &pp->posz, ( Voc3D_Flags ) ( v3df_dontpan | v3df_follow ), pp );
                    }
                }
            }
        ...
        case TAG_SECRET_AREA_TRIGGER:
            if ( pp == Player + myconnectindex )
                PlayerSound ( DIGI_ANCIENTSECRET, &pp->posx, &pp->posy, &pp->posz,
                              ( Voc3D_Flags ) ( v3df_dontpan | v3df_doppler | v3df_follow ), pp );
...
BOOL NearThings ( PLAYERp pp )
{
    ...
    if ( sector[pp->cursectnum].hitag == PLAYER_SOUNDEVENT_TAG )
    {
        if ( pp == Player + myconnectindex )
        {
            PlayerSound ( sector[pp->cursectnum].lotag, &pp->posx, &pp->posy, &pp->posz, ( Voc3D_Flags ) ( v3df_follow | v3df_dontpan ), pp );
        }
    ...
    if ( neartagsprite >= 0 )
    {
        ...
        if ( sp->hitag == PLAYER_SOUNDEVENT_TAG )
        {
            if ( pp == Player + myconnectindex )
            {
                PlayerSound ( sp->lotag, &pp->posx, &pp->posy, &pp->posz, ( Voc3D_Flags ) ( v3df_follow | v3df_dontpan ), pp );
            }
        }
    ...
    if ( neartagwall >= 0 )
    {
        ...
        if ( wall[neartagwall].hitag == PLAYER_SOUNDEVENT_TAG )
        {
            if ( pp == Player + myconnectindex )
            {
                PlayerSound ( wall[neartagwall].lotag, &pp->posx, &pp->posy, &pp->posz, ( Voc3D_Flags ) ( v3df_follow | v3df_dontpan ), pp );
            }
    ...
    // This only gets called if nothing else worked, check for nearness to a wall
    {
        ...
        if ( hitwall >= 0 )
        {
            ...
            if ( !TEST ( wp->extra, WALLFX_DONT_STICK ) && pp == Player + myconnectindex )
            {
                ...
                {
                    PlayerSound ( DIGI_HITTINGWALLS, &pp->posx, &pp->posy, &pp->posz, ( Voc3D_Flags ) ( v3df_follow | v3df_dontpan ), pp );
                }
                
                else
                {
                    PlayerSound ( DIGI_SEARCHWALL, &pp->posx, &pp->posy, &pp->posz, ( Voc3D_Flags ) ( v3df_follow | v3df_dontpan ), pp );
                }
            }
...
DoSineWaveWall ( VOID )
{
    ...
    for ( sw_num = 0; sw_num < MAX_SINE_WAVE; sw_num++ )
    {
        for ( sw = &SineWall[sw_num][0]; sw->wall >= 0 && sw < &SineWall[sw_num][MAX_SINE_WALL_POINTS]; sw++ )
        {
            ...
            if ( !sw->type )
            {
                newp = sw->orig_xy + ( ( sw->range * sintable[sw->sintable_ndx] ) >> 14 );
                // wall[sw->wall].y = newp;
                dragpoint ( sw->wall, wall[sw->wall].x, newp, 0 );
            }
            ...
            else
            {
                newp = sw->orig_xy + ( ( sw->range * sintable[sw->sintable_ndx] ) >> 14 );
                // wall[sw->wall].x = newp;
                dragpoint ( sw->wall, newp, wall[sw->wall].y, 0 );
            }
        }
    }
}
