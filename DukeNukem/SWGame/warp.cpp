...
SPRITEp
WarpPlane ( int32_t * x, int32_t * y, int32_t * z, SHORTp sectnum )
{
    ...
    if ( sp_ceiling )
    {
        if ( *z <= sp_ceiling->z )
        {
            return ( WarpToArea ( sp_ceiling, ( LONGp ) x, ( LONGp ) y, ( LONGp ) z, sectnum ) );
        }
    }
    ...
    if ( sp_floor )
    {
        if ( *z >= sp_floor->z )
        {
            return ( WarpToArea ( sp_floor, ( LONGp ) x, ( LONGp ) y, ( LONGp ) z, sectnum ) );
        }
    }
...
SPRITEp
Warp ( int32_t * x, int32_t * y, int32_t * z, SHORTp sectnum )
{
    SPRITEp sp_warp;
    ...
    if ( sp_warp )
    {
        return ( WarpToArea ( sp_warp, ( LONGp ) x, ( LONGp ) y, ( LONGp ) z, sectnum ) );
    }
