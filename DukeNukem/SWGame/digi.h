...
#ifdef DIGI_TABLE
    #define DIGI_ENTRY(name, id, id_num, pri, pitch_lo, pitch_hi, voc_num, voc_dist, voc_flags) { name, NULL, pitch_lo, pitch_hi, pri, voc_num, voc_dist, (Voc_Flags)voc_flags, 0,0},
#endif
