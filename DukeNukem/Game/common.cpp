...
static const char *defaultdeffilename[GAMECOUNT] = { "Assets/DukeData/duke3d.def", "nam.def", "napalm.def", "ww2gi.def" };
...
// jmarshall 
//#if defined(_WIN32)
//    if (!_access("user_profiles_enabled", F_OK))
//#else
