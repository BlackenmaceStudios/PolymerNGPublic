...
int32_t I_CheckAllInput(void)
{
    return (
            ...
            MOUSE_GetButtons() ||
            JOYSTICK_GetButtons() ||
			xBuildInputSystem->ControllerKeyDown(XB_Button_A)
            );
}
...
int32_t I_ReturnTrigger(void)
{
    return (
			...
			xBuildInputSystem->ControllerKeyDown(XB_Button_B) ||
...
int32_t I_MenuUp(void)
{
    return (
			...
			xBuildInputSystem->ControllerKeyDown(XB_Button_DPAD_Up) ||
...
int32_t I_MenuDown(void)
{
    return (
			...
			xBuildInputSystem->ControllerKeyDown(XB_Button_DPAD_Down) ||
...
int32_t I_MenuLeft(void)
{
    return (
			...
			xBuildInputSystem->ControllerKeyDown(XB_Button_DPAD_Left) ||
...
int32_t I_MenuRight(void)
{
    return (
            ...
            (!SHIFTS_IS_PRESSED && KB_KeyPressed(sc_Tab)) ||
		xBuildInputSystem->ControllerKeyDown(XB_Button_DPAD_Right) ||
