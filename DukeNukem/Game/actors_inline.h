...
ACTOR_INLINE_HEADER void G_UpdateInterpolations(void);
ACTOR_INLINE_HEADER void G_RestoreInterpolations(void);

ACTOR_INLINE_HEADER int32_t G_CheckForSpaceCeiling(int32_t sectnum);
ACTOR_INLINE_HEADER int32_t G_CheckForSpaceFloor(int32_t sectnum);

ACTOR_INLINE_HEADER int32_t A_CheckEnemySprite(const spritetype *s);
