...
class idModelShared : public buildModelBase
{
public:
...
class mdmodel_t : public buildModelBase 
{
...
class md2model_t : public idModelShared
{
public:
    //MD2 specific stuff:
...
class md3model_t : public idModelShared
{
public:
    //MD3 specific
    md3head_t head;
