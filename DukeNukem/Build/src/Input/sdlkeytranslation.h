...
static KeySDLMapping keytranslation[SDLK_LAST];
#else
static KeySDLMapping keytranslation[SDL_NUM_SCANCODES];
#endif
...
#define MAP(x,y) keytranslation[numKeys].sdlkey = x; keytranslation[numKeys++].buildkey = y;
...
extern "C" extern char keystatus[256];